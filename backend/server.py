...
db_name = os.environ.get('DB_NAME', 'cafe_tab_db')

client = AsyncIOMotorClient(mongo_url)
db = client[db_name]

# 1. Create the main app
app = FastAPI(title="Cafe TAB API")

# 2. Configure CORS BEFORE adding routes
# We explicitly include your Vercel URL to stop the "Blocked by CORS" error.
origins = [
    "https://cafe-tab.vercel.app",
    "http://localhost:3000",
    "http://localhost:5173",
]

# If you have CORS_ORIGINS in your .env, add those too
